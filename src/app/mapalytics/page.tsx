...
const PipedriveForm = () => {
    const formHTML = `
      <div class="pipedriveWebForms" data-pd-webforms="https://webforms.pipedrive.com/f/ckzzoUTBTKexrv9epaEihrOcjpzC0G7rDkD5Ax7qLY97IC4RMOlnZvphMYzFa5dYNZ">
    ...
    <>
        <header>
            ...
            <nav>
                ...
                <div className="dropdown">
                    <Link className="dropdown__link dropdown--novo" href="/mapalytics">mapalytics</Link>
